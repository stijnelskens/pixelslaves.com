...
const Layout = ({ children, header, title = 'PixelSlaves.com' }: Props) => {
  return (
    <Plausible domain="pixelslaves.com">
      <div className="h-full">
        <Head>
          ...
          <meta name="keywords" content="Gaming, Call of Duty, Warzone, DayZ, Rust, Apex, Counter Strike, gta,  Community, Twitch, Kick, streaming" />
          <Favicon />
        </Head>
        {header && <Header />}
