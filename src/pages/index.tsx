...
import { IoLogoTwitch, IoLogoTiktok, IoLogoInstagram, IoLogoDiscord } from 'react-icons/io5';
      ...
      <div className="border-t-4 border-red-500">
        <div className="container">
          ...
          <div className="mt-6 text-center animate-fade-in animate-delay-100">
            <Link href="/crew">
              <a className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 hover:bg-red-800">Check de crew</a>
            </Link>
          </div>
          <div className="pt-20 pb-12 text-center animate-fade-in animate-delay-100">
            <div className="flex items-center justify-center gap-2.5 mb-4">
              <h2 className="mb-0 text-3xl font-medium">Po.Pups Drop</h2>
              <a href="https://www.instagram.com/po.pups/" target="_blank" rel="noopener noreferrer" className="text-3xl hover:text-orange-400">
                <span className="sr-only">Instagram</span>
                <IoLogoInstagram className="w-6 h-6" />
              </a>
            </div>
            <div className="flex flex-wrap justify-center -mx-4">
              <div className="w-full px-4 mt-8 sm:w-1/2 md:w-1/4">
                <a href="https://shop.pixelslaves.com/product/pup-corduroy-hat/" target="_blank" rel="noopener noreferrer" className="flex flex-col p-1 group">
                  <div className="transition-transform duration-300 ease-in-out group-hover:-translate-y-2">
                    <Image src="https://shop.pixelslaves.com/wp-content/uploads/2023/08/corduroy-hat-camel-front-64d1496161d9f.png" alt="PixelSlaves tshirt white" className="rounded-full" width={350} height={350} />
                  </div>
                  <div className="mt-4">
                  ...
                  <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 group-hover:bg-red-800">Nu kopen</span>
                  </div>
                </a>
              </div>
              <div className="w-full px-4 mt-8 sm:w-1/2 md:w-1/4">
                <a href="https://shop.pixelslaves.com/product/pup-dad-hat/" target="_blank" rel="noopener noreferrer" className="flex flex-col p-1 group">
                  <div className="transition-transform duration-300 ease-in-out group-hover:-translate-y-2">
                    <Image src="https://shop.pixelslaves.com/wp-content/uploads/2023/08/classic-dad-hat-stone-front-64d148bfb24f7.png" alt="PixelSlaves tshirt white" className="rounded-full" width={350} height={350} />
                  </div>
                  <div className="mt-4">
                  {/* <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 rounded-lg group-hover:bg-red-800">Nu kopen <IoBag className="ml-2" /></span> */}
                  <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 group-hover:bg-red-800">Nu kopen</span>
              ...
              <div className="w-full px-4 mt-8 sm:w-1/2 md:w-1/4">
                <a href="https://shop.pixelslaves.com/product/puppy-logo-dad-hat/" target="_blank" rel="noopener noreferrer" className="flex flex-col p-1 group">
                  <div className="transition-transform duration-300 ease-in-out group-hover:-translate-y-2">
                    <Image src="https://shop.pixelslaves.com/wp-content/uploads/2023/08/classic-dad-hat-black-front-64d1490f0cb68.png" alt="PixelSlaves tshirt black" width={350} height={350} />
                  </div>
                  <div className="mt-4">
                    {/* <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 rounded-lg group-hover:bg-red-800">Nu kopen <IoBag className="ml-2" /></span> */}
                    <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 group-hover:bg-red-800">Nu kopen</span>
              ...
              <div className="w-full px-4 mt-8 sm:w-1/2 md:w-1/4">
                <a href="https://shop.pixelslaves.com/product/puppy-logo-corduroy-hat/" target="_blank" rel="noopener noreferrer" className="flex flex-col p-1 group">
                  <div className="transition-transform duration-300 ease-in-out group-hover:-translate-y-2">
                    <Image src="https://shop.pixelslaves.com/wp-content/uploads/2023/08/corduroy-hat-camel-front-64d1494399133.png" alt="PixelSlaves tshirt black" width={350} height={350} />
                  </div>
                  <div className="mt-4">
                    {/* <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 rounded-lg group-hover:bg-red-800">Nu kopen <IoBag className="ml-2" /></span> */}
                    <span className="inline-flex items-center px-6 py-2 font-medium text-white uppercase transition duration-300 ease-in-out bg-red-600 group-hover:bg-red-800">Nu kopen</span>
