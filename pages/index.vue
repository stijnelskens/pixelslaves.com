...
<template>
  <section class="flex items-center h-[calc(100vh-173px)]">
    <div class="container px-4 mx-auto text-center">
      <Logo v-motion-slide-visible-once-top class="w-56 mx-auto sm:w-60" />
      <h1
      ...
      <div v-motion-fade-visible-once :delay="400">
        <UButton
