      ...
      <div className="border-t-4 border-red-500">
        <div className="container">
          ...
          <div className="pt-20 pb-12 text-center">
            <h2 className="mb-4 text-3xl font-medium dark:text-white">Clothing</h2>
            <div className="flex flex-wrap justify-center -mx-4">
              <div className="w-full px-4 mt-8 md:w-1/4">
                <a href="/" target="_blank" rel="noopener noreferer" className="flex flex-col p-1 group">
